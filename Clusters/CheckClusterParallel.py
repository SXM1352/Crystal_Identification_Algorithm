...
class C_Cluster(object):
    ...
    def __read_data_COG(self, HVD):
        try:
            print("Read: {}hdf5Data/pv{}ref.pickle".format(self.pathtodirectoryRead, HVD))
            with open("{}/hdf5Data/pv{}ref.pickle".format(self.pathtodirectoryRead, HVD), 'rb') as handle:
        ...
        try:
            print('Read: {}hdf5Data/cog{}ref.pickle'.format(self.pathtodirectoryRead, HVD))
            with open('{}/hdf5Data/cog{}ref.pickle'.format(self.pathtodirectoryRead, HVD), 'rb') as handle:
                cogHVDtest = pickle.load(handle)  # 000, 100, 010, 111 order of columns!!!
        except:
            print('{}hdf5Data/cog{}ref.pickle doesn work'.format(self.pathtodirectoryRead, HVD))
            cogHVDtest = -1
