...
def main():
    ...
    pathtodirectory, savedirectory = args.fileDirect
    ...
    command_ReadDB_Photon = 'python /home/david.perez/cia/CreateData/ReadDebugSinglesCRT_Photon.py --fileDirectory {} --saveDirectory {}'.format(pathtodirectory, savedirectory)
    os.system(command_ReadDB_Photon)

    command_ReadDB_Pos = 'python /home/david.perez/cia/CreateData/ReadDebugSinglesCRT_Pos.py --fileDirectory {} --saveDirectory {}'.format(
        pathtodirectory, savedirectory)
    os.system(command_ReadDB_Pos)

    command_ReadDB_TimeStamp = 'python /home/david.perez/cia/CreateData/ReadDebugSinglesCRT_TimeStamp.py --fileDirectory {} --saveDirectory {}'.format(
        pathtodirectory, savedirectory)
    os.system(command_ReadDB_TimeStamp)

    command_ReadDB_Val = 'python /home/david.perez/cia/CreateData/ReadDebugSinglesCRT_Val.py --fileDirectory {} --saveDirectory {}'.format(
        pathtodirectory, savedirectory)
    os.system(command_ReadDB_Val)

    command_ReadDB_PV = 'python /home/david.perez/cia/CreateData/ReadDebugSinglesCRT_PV.py --fileDirectory {} --saveDirectory {}'.format(
        pathtodirectory, savedirectory)
    os.system(command_ReadDB_PV)

    command_NH = 'python /home/david.perez/cia/CreateData/NewHypmed_main.py --fileDirectory {}'.format(savedirectory)
    os.system(command_NH)

    command_CiA = 'python /home/david.perez/cia/ScriptoRun/RunCiA.py --fileDirectory {} --HVD -1 --nCPU 6 --precision 0.1 --nEvents 30'.format(savedirectory)
